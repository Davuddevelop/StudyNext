...
function Sidebar() {
    ...
    return (
        <aside style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '3rem', padding: '0.75rem', border: '2px solid #e2e8f0', background: 'var(--surface)', borderRadius: '12px' }}>
                <div className="logo-badge" style={{ '--logo-size': '48px', border: 'none', boxShadow: 'none' }}>
                    <img src={logo} alt="TaskFlow" />
                </div>
                <span style={{ fontSize: '1.4rem', fontWeight: '800', color: '#0f172a', letterSpacing: '-0.5px' }}>TaskFlow</span>
            </div>
        ...
        <div style={{ minHeight: '100vh', backgroundColor: 'var(--bg-color)', display: 'flex' }}>
            ...
            <main style={{
                ...
                <header style={{
                    ...
                    <div style={{ fontSize: '1.2rem', fontWeight: 'bold', display: isMobile ? 'none' : 'block' }}>
                        {new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                    </div>
                    {isMobile && (
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                            <div className="logo-badge" style={{ '--logo-size': '64px' }}>
                                <img src={logo} alt="TaskFlow" />
                            </div>
                            <span style={{ fontSize: '1.5rem', fontWeight: '900', color: 'var(--primary)', letterSpacing: '-0.5px' }}>TaskFlow</span>
                        </div>
                    )}
                    <Link to="/settings" style={{ display: 'flex', alignItems: 'center', gap: '1rem', textDecoration: 'none' }}>
