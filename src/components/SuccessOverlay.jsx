...
export default function SuccessOverlay({
    ...
    // Generate random confetti properties once per render to satisfy React purity rules
    const confettiProps = useMemo(() => {
        const count = didLevelUp ? 40 : 20;
        return [...Array(count)].map((_, i) => ({
            i,
            bg: i % 3 === 0 ? 'var(--primary)' : i % 3 === 1 ? 'var(--accent)' : '#ffbd2e',
            anim: `confetti ${1 + Math.random() * (didLevelUp ? 2 : 1)}s ease-out forwards`,
