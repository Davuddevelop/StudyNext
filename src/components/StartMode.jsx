...
import { IoCloseCircleOutline, IoRocketOutline, IoSparklesOutline, IoHeartOutline, IoFitnessOutline } from 'react-icons/io5';
        ...
        <div style={{
            ...
            <div className="animate-fade-up" style={{ textAlign: 'center' }}>
                <div style={{
                    ...
                    <FaBrain className="animate-float" style={{ color: '#FF6B4A', fontSize: '2.5rem' }} />
                    <span style={{
